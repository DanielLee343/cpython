...
void _PyMem_ArenaFree(void *Py_UNUSED(ctx), void *ptr,
...
void _PyObject_VirtualFree(void *obj, size_t size)
{
...
void _PyInterpreterState_FinalizeAllocatedBlocks(PyInterpreterState *interp)
{
    if (has_own_state(interp))
    {
...
void _Py_FinalizeAllocatedBlocks(_PyRuntimeState *runtime)
{
...
void _PyInterpreterState_FinalizeAllocatedBlocks(PyInterpreterState *Py_UNUSED(interp))
{
    return;
}

void _Py_FinalizeAllocatedBlocks(_PyRuntimeState *Py_UNUSED(runtime))
{
    return;
}
...
*/
void _PyMem_DebugRawFree(void *ctx, void *p)
{
...
void _PyMem_DebugFree(void *ctx, void *ptr)
{
    _PyMem_DebugCheckGIL(__func__);
