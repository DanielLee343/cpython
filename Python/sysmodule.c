...
int _PySys_ClearAttrString(PyInterpreterState *interp,
...
should_audit(PyInterpreterState *interp)
{
    ...
    return (interp->runtime->audit_hooks.head || interp->audit_hooks || PyDTrace_AUDIT_ENABLED());
}
...
_PySys_GetSizeOf(PyObject *o)
{
    ...
    // {
    //     fprintf(stderr, "op is a string: ");
    //     PyObject_Print(o, stderr, 1);
    //     fprintf(stderr, "\n");
    //     return (size_t)-1;
    // }
    ...
    else
    {
        ...
        // Py_DECREF(method); // commented out to prevent segfault doing getsizeof duing IO, remember to uncomment
    }

    if (res == NULL)
    {
        fprintf(stderr, "wrong111!!\n");
        return (size_t)-1;
    }
    ...
    {
        fprintf(stderr, "wrong222!!\n");
        return (size_t)-1;
    }

    if (size < 0)
    {
        fprintf(stderr, "wrong333!!\n");
        _PyErr_SetString(tstate, PyExc_ValueError,
...
static PyMethodDef sys_methods[] = {
    ...
    SYS_ADDAUDITHOOK_METHODDEF{"audit", _PyCFunction_CAST(sys_audit), METH_FASTCALL, audit_doc},
    ...
    SYS_GETTOTALREFCOUNT_METHODDEF
        SYS_GETREFCOUNT_METHODDEF
            SYS_GETRECURSIONLIMIT_METHODDEF{"getsizeof", _PyCFunction_CAST(sys_getsizeof),
            ...
            SYS_CALL_TRACING_METHODDEF
                SYS__DEBUGMALLOCSTATS_METHODDEF
                    SYS_SET_COROUTINE_ORIGIN_TRACKING_DEPTH_METHODDEF
                        SYS_GET_COROUTINE_ORIGIN_TRACKING_DEPTH_METHODDEF{"set_asyncgen_hooks", _PyCFunction_CAST(sys_set_asyncgen_hooks),
