...
#define MAX_SAMPLE_NUM 9999
#define MAX_OBJ_NUM 9999
    ...
    */
    ...
    //     // PyObject *obj_tracked;
    //     /*A list of tracked objects */
    //     struct refcnt_each_obj refcnt_each_obj_[MAX_OBJ_NUM];
    // };

    // struct _reftrack_runtime_state
    // {
    //     // TODO_yuze: needed fields?
    //     int enabled;
    //     struct ref_tracked ref_tracked_[MAX_SAMPLE_NUM];
    // };
